...
New-NetFirewallRule -DisplayName "Allow SSHTCP Outbound"  -Direction Outbound  -Protocol TCP  -LocalPort 22  -RemoteAddress 172.20.241.40  -Action Allow  -Service "sshd"  -Profile Any
New-NetFirewallRule -DisplayName "Allow SSHTCP Inbound"  -Direction Inbound  -Protocol TCP  -LocalPort 22 -RemoteAddress 172.20.241.40 -Action Allow  -Service "sshd"  -Profile Any
New-NetFirewallRule -DisplayName "Allow SSHUDP Outbound"  -Direction Outbound  -Protocol UDP  -LocalPort 22 -RemoteAddress 172.20.241.40  -Action Allow  -Service "sshd"  -Profile Any
New-NetFirewallRule -DisplayName "Allow SSHUDP Inbound"  -Direction Inbound  -Protocol UDP  -LocalPort 22 -RemoteAddress 172.20.241.40  -Action Allow  -Service "sshd"  -Profile Any

New-NetFirewallRule -DisplayName "Allow HTTP Outbound"  -Direction Outbound  -Protocol TCP  -LocalPort 80  -RemoteAddress 172.20.241.40  -Action Allow  -Service "http"  -Profile Any
New-NetFirewallRule -DisplayName "Allow HTTP Inbound"  -Direction Inbound  -Protocol TCP  -LocalPort 80  -RemoteAddress 172.20.241.40  -Action Allow  -Service "http"  -Profile Any

New-NetFirewallRule -DisplayName "Allow KerberosTCP Outbound"  -Direction Outbound  -Protocol TCP  -LocalPort 88  -RemoteAddress 172.20.241.40  -Action Allow  -Service "krb5"  -Profile Any
New-NetFirewallRule -DisplayName "Allow KerberosTCP Inbound"  -Direction Inbound  -Protocol TCP  -LocalPort 88  -RemoteAddress 172.20.241.40  -Action Allow  -Service "krb5"  -Profile Any
New-NetFirewallRule -DisplayName "Allow KerberosUDP Outbound"  -Direction Outbound  -Protocol UDP  -LocalPort 88  -RemoteAddress 172.20.241.40  -Action Allow  -Service "krb5"  -Profile Any
New-NetFirewallRule -DisplayName "Allow KerberosUDP Inbound"  -Direction Inbound  -Protocol UDP  -LocalPort 88  -RemoteAddress 172.20.241.40  -Action Allow  -Service "krb5"  -Profile Any

New-NetFirewallRule -DisplayName "Allow RPC/WMI Outbound"  -Direction Outbound  -Protocol TCP  -LocalPort 135  -RemoteAddress 172.20.241.40  -Action Allow  -Service "rpcss"  -Profile Any
New-NetFirewallRule -DisplayName "Allow RPC/WMI Inbound"  -Direction Inbound  -Protocol TCP  -LocalPort 135  -RemoteAddress 172.20.241.40  -Action Allow  -Service "rpcss,winmgmt"  -Profile Any

New-NetFirewallRule -DisplayName "Allow KerbPass Outbound"  -Direction Outbound  -Protocol TCP  -LocalPort 464  -RemoteAddress 172.20.241.40  -Action Allow  -Service "kpasswd"  -Profile Any
New-NetFirewallRule -DisplayName "Allow KerbPass Inbound"  -Direction Inbound  -Protocol TCP  -LocalPort 464  -RemoteAddress 172.20.241.40  -Action Allow  -Service "kpasswd"  -Profile Any
New-NetFirewallRule -DisplayName "Allow KerbPass Outbound"  -Direction Outbound  -Protocol UDP  -LocalPort 464  -RemoteAddress 172.20.241.40  -Action Allow  -Service "kpasswd"  -Profile Any
New-NetFirewallRule -DisplayName "Allow KerbPass Inbound"  -Direction Inbound  -Protocol UDP  -LocalPort 464  -RemoteAddress 172.20.241.40  -Action Allow  -Service "kpasswd"  -Profile Any

New-NetFirewallRule -DisplayName "Allow LDAP Outbound"  -Direction Outbound  -Protocol TCP  -LocalPort 389  -RemoteAddress 172.20.241.40  -Action Allow  -Service "ldap"  -Profile Any
New-NetFirewallRule -DisplayName "Allow LDAP Inbound"  -Direction Inbound  -Protocol TCP  -LocalPort 389  -RemoteAddress 172.20.241.40  -Action Allow  -Service "ldap"  -Profile Any
New-NetFirewallRule -DisplayName "Allow LDAP Outbound"  -Direction Outbound  -Protocol UDP  -LocalPort 389  -RemoteAddress 172.20.241.40  -Action Allow  -Service "ldap"  -Profile Any
New-NetFirewallRule -DisplayName "Allow LDAP Inbound"  -Direction Inbound  -Protocol UDP  -LocalPort 389  -RemoteAddress 172.20.241.40  -Action Allow  -Service "ldap"  -Profile Any
